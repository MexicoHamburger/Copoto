        ...
        <form onSubmit={handleRegister}>
          <div className="mb-4">
            <input 
              type="text"
              id="username"
              className= {`w-full p-4 border rounded-t-lg rounded-b-none ${formErrors.id ? "border-2 border-red-500" : "border-b-0 border-gray-300"}`}
              value={username}
              placeholder="아이디"
            ...
            <input 
              type="text"
              id="nickname"
              className={`w-full p-4 border rounded-b-lg ${formErrors.nickname ? "border-2 border-red-500" : "border-t-0 border-gray-300"}`}
              value={nickname}
              placeholder="닉네임"
